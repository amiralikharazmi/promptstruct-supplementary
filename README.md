...
This repository contains all supplementary prompt templates used in the PromptStruct framework, described in the paper:

**PromptStruct: A Three-Stage Framework for Scientific Writing Enhancement using LLMs**
...
For detailed usage and methodology, refer to the main paper.
